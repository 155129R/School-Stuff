...
void Assignment3::Render()
{
    ...
    if (sleepBed == true)
        RenderTextOnScreen(meshList[GEO_TEXT], "Press 'U' to wake up", Color(0, 1, 0), 100, 20, 20);
    ...
    if (canCoke == true){
        ...
        RenderTextOnScreen(meshList[GEO_TEXT], "Press 'U' to drink", Color(0, 1, 0), 100, 20, 20);
