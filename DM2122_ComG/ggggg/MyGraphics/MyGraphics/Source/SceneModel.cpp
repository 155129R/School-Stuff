...
void SceneModel::Init()
{
    ...
    camera.Init(Vector3(0, 0, 10), Vector3(0, 2, 0), Vector3(0, 1, 0));


    meshList[GEO_AXES] = MeshBuilder::GenerateAxes("reference", 1000, 1000, 1000);
    meshList[GEO_LIGHTBALL] = MeshBuilder::GenerateSphere("LightBall", (1, 1, 1), 18, 36);

    meshList[GEO_MODEL1] = MeshBuilder::GenerateOBJ("Chair", "OBJ//Spacevehicle.obj");
...
void SceneModel::RenderSkybox(){
    ...
    modelStack.Translate(0, 499.5f, 0);
    ...
    modelStack.Translate(0, 0, -499.5f);
    ...
    //LEFT
    modelStack.PushMatrix();
    modelStack.Translate(-499.5f, 0, 0);
