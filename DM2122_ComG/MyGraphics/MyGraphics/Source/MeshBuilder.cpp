...
Mesh* MeshBuilder::GenerateQuad(const std::string &meshName, Color color)
{
	...
	v.pos.Set(0.5f, 0.f, -0.5f);  v.color = color;  v.texCoord.Set(10, 0);	    vertex_buffer_data.push_back(v);
    v.pos.Set(-0.5f, 0.f, -0.5f); v.color = color;	v.texCoord.Set(10, 10);     vertex_buffer_data.push_back(v);
    v.pos.Set(0.5f, 0.f, 0.5f);	  v.color = color;	v.texCoord.Set(0, 0);       vertex_buffer_data.push_back(v);
    v.pos.Set(-0.5f, 0.f, -0.5f); v.color = color;	v.texCoord.Set(10, 10);       vertex_buffer_data.push_back(v);
    v.pos.Set(-0.5f, 0.f, 0.5f);  v.color = color;	v.texCoord.Set(0, 10);       vertex_buffer_data.push_back(v);
